package bloomsemr.excelDataReader;
...
public class PharmacyDataReader {
	
	public ArrayList<String> getPharmacyData(String testcaseName) throws IOException {
		// fileInputStream argument
		ArrayList<String> a = new ArrayList<String>();

		FileInputStream fis = new FileInputStream("/home/cubet/Desktop/WorldAutomation/BloomsInputs/PharmacyDetails.xlsx");
		XSSFWorkbook workbook = new XSSFWorkbook(fis);

		int sheets = workbook.getNumberOfSheets();
		for (int i = 0; i < sheets; i++) {
			if (workbook.getSheetName(i).equalsIgnoreCase("Pharmacies")) {
