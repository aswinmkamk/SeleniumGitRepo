...
public class UserDataReader {
    ...
    public ArrayList<String> getPharmacyData(String testcaseName) throws IOException {
        ...
        FileInputStream fis = new FileInputStream("/home/cubet/Desktop/WorldAutomation/BloomsInputs/Users.xlsx");
    ...
    public static void main(String[] args) throws IOException {
        ...
        ArrayList<String> userData = reader.getPharmacyData("YourTestCaseName");
